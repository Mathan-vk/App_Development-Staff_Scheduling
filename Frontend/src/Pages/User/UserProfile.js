...
import {
  Button, Modal, TextField, Box, Card, CardContent, Typography, Avatar, Grid, IconButton, Snackbar,
} from '@mui/material';
import {
  Edit as EditIcon, Email as EmailIcon, Phone as PhoneIcon, Home as HomeIcon, Work as WorkIcon, Cake as CakeIcon, CameraAlt as CameraAltIcon,
...
const UserProfile = () => {
  ...
  const handleSave = () => {
    if (editableProfile.email && !/\S+@\S+\.\S+/.test(editableProfile.email)) {
              ...
              <Box sx={{ position: 'relative' }}>
                <Avatar
                  ...
                  sx={{
                    width: 120,
                    height: 120,
                    border: `3px solid ${isDarkTheme ? '#fff' : '#000'}`,
                  }}
                />
                <input
                  accept="image/*"
