      ...
      <Box sx={{ width: drawerWidth }} role="presentation">
        <List>
          <ListItem disablePadding>
            <ListItemButton component = {Link} to = "/Userprofile"sx={listItemStyle}>
        ...
        <Divider />
        <ListItem disablePadding>
          <ListItemButton component={Link} to="/User/StaffDashboard" sx={listItemStyle}>
            <ListItemIcon sx={iconStyle}>
              <DashboardIcon />
            </ListItemIcon>
        ...
        <Divider />
        <ListItem disablePadding>
          <ListItemButton component={Link} to="/User/my-schedule" sx={listItemStyle}>
            <ListItemIcon sx={iconStyle}>
              <CalendarTodayIcon />
            </ListItemIcon>
        ...
        <Divider />
        <Link to="/User/time-off-requests" style={{ textDecoration: 'none', color: 'inherit' }}>
          <ListItem disablePadding>
        ...
        <Divider />
        <Link to="/User/shift-swapping" style={{ textDecoration: 'none', color: 'inherit' }}>
          <ListItem disablePadding>
            <ListItemButton sx={listItemStyle}>
              <ListItemIcon sx={iconStyle}>
                <DashboardIcon />
        ...
        <Divider />
        <Link to="/User/profile-settings" style={{ textDecoration: 'none', color: 'inherit' }}>
          <ListItem disablePadding>
            <ListItemButton sx={listItemStyle}>
              <ListItemIcon sx={iconStyle}>
                <AccountCircleIcon />
